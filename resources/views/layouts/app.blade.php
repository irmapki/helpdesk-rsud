                        ...
                        @elseif(request()->routeIs('supervisor.*'))
                            <div>
                                ...
                                <nav class="space-y-1.5 mb-6">
                                    ...
                                    <!-- DIPERBAIKI: Mengarah ke route monitoring-sla -->
                                    <a href="{{ route('supervisor.monitoring-sla') }}" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold transition {{ request()->routeIs('supervisor.monitoring-sla') ? 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-md shadow-emerald-600/20' : 'text-gray-600 hover:bg-gray-50 hover:text-emerald-600' }}">
                                ...
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2 px-3">SISTEM</p>
                                <nav class="space-y-1.5">
                                    <a href="#" class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold text-gray-600 hover:bg-gray-50 hover:text-emerald-600 transition">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
