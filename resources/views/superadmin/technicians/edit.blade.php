<x-app-layout>
    <div class="space-y-6 max-w-2xl mx-auto">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Edit Data &amp; Kontak Teknisi</h1>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/90 shadow-xs p-6 sm:p-8">
            <form action="{{ route('superadmin.technicians.update', $technician) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="text-xs font-bold text-slate-800 bg-slate-50 p-3 rounded-xl border border-slate-200">
                ...
                <div class="pt-4 border-t border-slate-100 flex justify-end gap-2">
                    ...
                    <button type="submit" class="px-6 py-2.5 rounded-xl text-xs font-bold text-white bg-[#0f333a] hover:bg-[#092227] shadow-xs transition">Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
