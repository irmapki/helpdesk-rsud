<x-app-layout>
    ...
    <x-slot name="breadcrumb">
        Super Admin &rsaquo; Manajemen Pengguna &rsaquo; Tambah User
    </x-slot>
    ...
    <div class="p-6 lg:p-8 space-y-6 max-w-[1000px] mx-auto">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-1">Daftarkan akun staf IT, teknisi, atau pimpinan rumah sakit.</p>
            </div>
            ...
            <form action="{{ route('superadmin.users.store') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full text-xs rounded-xl border-slate-200 focus:ring-teal-500 focus:border-teal-500" placeholder="contoh: Dedi Kurniawan, S.Kom">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" required class="w-full text-xs rounded-xl border-slate-200 focus:ring-teal-500 focus:border-teal-500" placeholder="contoh: dedi.k@rsudsoewondo.go.id">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="w-full text-xs rounded-xl border-slate-200 focus:ring-teal-500 focus:border-teal-500" placeholder="081234567890">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" required class="w-full text-xs rounded-xl border-slate-200 focus:ring-teal-500 focus:border-teal-500" placeholder="Minimal 8 karakter">
                ...
                <div>
                    ...
                    <input type="text" name="specialization" id="specialization" value="{{ old('specialization') }}" class="w-full text-xs rounded-xl border-slate-200 focus:ring-teal-500 focus:border-teal-500" placeholder="contoh: Hardware, Printer Resep, SIMRS & Bridging BPJS, Jaringan LAN">
                </div>
