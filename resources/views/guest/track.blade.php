                        ...
                        @if ($ticket->technician)
                            <div class="mt-4 p-4 rounded-2xl bg-emerald-50/50 border border-emerald-200/80 flex items-center justify-between">
                                ...
                                @if ($ticket->technician->phone)
                                    ...
                                    @endphp
                                    <a href="https://wa.me/{{ $cleanPhone }}?text={{ $waMessage }}" target="_blank" class="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-800 bg-white hover:bg-emerald-100 border border-emerald-300 px-4 py-2.5 rounded-2xl transition shadow-xs">
