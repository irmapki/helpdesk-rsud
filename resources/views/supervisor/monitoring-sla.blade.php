    ...
    <div class="space-y-4 sm:space-y-6 max-w-full overflow-x-hidden pb-10">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 min-w-0">
            ...
            <div class="flex items-center gap-2 shrink-0">
                <a href="{{ route('supervisor.laporan-tiket.export', array_merge(request()->all(), ['type' => 'sla'])) }}" class="inline-flex items-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs px-4 py-2.5 rounded-2xl shadow-xs transition">
